...
public class HttpClientUtil {
    ...
    public static List<NameValuePair> getParams(Object[] params, Object[] values) {
        ...
        if (flag) {
            ...
            log.error("HttpClientService-errorMsg：{}", "请求参数为空/参数长度不一致");
        }
        return null;
    }
...
//                    httpGet.setHeader(new BasicHeader(Key, val));
//                });
//            } else {
//
//            }
    ...
    public static PoolingHttpClientConnectionManager ConnectionManagerBuilder() throws NoSuchAlgorithmException,
